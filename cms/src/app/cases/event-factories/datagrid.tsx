...
function EventFactoryDataGrid() {
  const location = useLocation();

  const [eventFactorys, setEventFactorys] = useState<IEventFactory[]>([]);

  useEffect(()=> {
      EventFactoryService.getAll()
        .then(result => {
          setEventFactorys(result.data)
        })
...
export default EventFactoryDataGrid;